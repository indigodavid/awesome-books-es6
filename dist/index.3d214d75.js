...
var _storageBooksJs = require("./modules/storageBooks.js");
var _storageBooksJsDefault = parcelHelpers.interopDefault(_storageBooksJs);
var _toggleVisibilityJs = require("./modules/toggleVisibility.js");
var _toggleVisibilityJsDefault = parcelHelpers.interopDefault(_toggleVisibilityJs);
var _clearClassesJs = require("./modules/clearClasses.js");
var _clearClassesJsDefault = parcelHelpers.interopDefault(_clearClassesJs);
...
document.getElementById("date").innerHTML = (0, _luxon.DateTime).now().toLocaleString((0, _luxon.DateTime).DATETIME_MED);
// Load books in local storage
document.addEventListener("DOMContentLoaded", (0, _storageBooksJsDefault.default).loadData);
// Add books from form
addBook.addEventListener("click", (0, _storageBooksJsDefault.default).addLi);
// Set visible the book list
allBooksSection.classList.add("active");
allBooksSection.classList.remove("hide-class");
listLink.addEventListener("click", ()=>{
    (0, _toggleVisibilityJsDefault.default)(allBooksSection);
    (0, _clearClassesJsDefault.default)(addNewBookSection, contactSection);
});
addLink.addEventListener("click", ()=>{
    (0, _toggleVisibilityJsDefault.default)(addNewBookSection);
    (0, _clearClassesJsDefault.default)(allBooksSection, contactSection);
});
contactLink.addEventListener("click", ()=>{
    (0, _toggleVisibilityJsDefault.default)(contactSection);
    (0, _clearClassesJsDefault.default)(allBooksSection, addNewBookSection);
});

},{"./modules/storageBooks.js":"in3SU","./modules/toggleVisibility.js":"l6Nj6","./modules/clearClasses.js":"4GCgu","luxon":"dpK6X","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"in3SU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _bookJs = require("./book.js");
var _bookJsDefault = parcelHelpers.interopDefault(_bookJs);
var _getLiJs = require("./getLi.js");
var _getLiJsDefault = parcelHelpers.interopDefault(_getLiJs);
...
class StorageBooks {
    ...
    static loadData() {
        ...
        if (data) {
            ...
            bookData.forEach((book)=>{
                bookList.appendChild((0, _getLiJsDefault.default)(book.title, book.author, book.id));
            });
        }
        document.querySelectorAll(".remove").forEach((button)=>{
            button.addEventListener("click", ()=>{
    ...
    static addLi() {
        if (newTitle.value && newAuthor.value) {
            let bookData = localStorage.getItem("bookData") ? JSON.parse(localStorage.getItem("bookData")) : [];
            const id = Date.now();
            const book = new (0, _bookJsDefault.default)(newTitle.value, newAuthor.value, id);
            bookData.push(book);
            bookList.appendChild((0, _getLiJsDefault.default)(book.title, book.author, book.id));
            StorageBooks.storeData(bookData);
            newTitle.value = "";
...
},{"./book.js":"5AaGw","./getLi.js":"iS3rq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5AaGw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Book {
...
},{}],"iS3rq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = getLi;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l6Nj6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = toggleVisbility;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4GCgu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["dB9nQ","bB7Pu"], "bB7Pu", "parcelRequire8188")
